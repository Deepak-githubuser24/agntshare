...
export function createAgentShareServer(config) {
        ...
        tools: [
            {
                ...
                description: "Upload content to AgentShare and mint a short pathway token. " +
            ...
            },
            {
                ...
                description: "Resolve a pathway token to retrieve shared content from AgentShare. " +
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        if (name === "agentshare_resolve") {
            ...
            const resolved = await apiRequest(config, "GET", `/resolve/${token}${intentQuery}`);
